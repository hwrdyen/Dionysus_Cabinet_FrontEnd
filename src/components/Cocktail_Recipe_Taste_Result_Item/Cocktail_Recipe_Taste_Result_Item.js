        ...
        <>
            <div className="Cocktail_Recipe_Taste_Result_Item--card" id={props.id}>
                <NavLink to={`/cocktail_recipe/${props.CurrentTasteRecipeItem?.id}`}>
                    <img className="Cocktail_Recipe_Taste_Result_Item--image" src={`https://dionysus-cabinet-backend.herokuapp.com/assets/Cocktail_Type/${props.CurrentTasteRecipeItem?.img_id}.jpg`} alt="Cocktail for Taste Result"/>
