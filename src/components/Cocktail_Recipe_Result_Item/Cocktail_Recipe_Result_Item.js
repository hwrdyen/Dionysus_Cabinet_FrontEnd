        ...
        <>
            <section className="Cocktail_Recipe_Result_Item" id={props.id}>
                <NavLink to={`/cocktail_recipe/${props.CurrentAlcoholRecipe_info.id}`}>
                    <img className="Result-Item__image" src={`https://dionysus-cabinet-backend.herokuapp.com/assets/Cocktail_Type/${props.CurrentAlcoholRecipe_info?.img_id}.jpg`} alt="Cocktail Result"/>
