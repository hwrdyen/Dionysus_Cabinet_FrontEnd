...
function Upload(props) {
    ...
    const onSubmit = (event) => {
        ...
        let author_email_value = document.getElementById("Recipe_Author_Email").value;
        ...
        let upload_ingredients_container = document.getElementById("upload_ingredients_container");
        let length_of_upload_ingredientschildNodes = upload_ingredients_container.childNodes.length;
        for (let i = 0; i<length_of_upload_ingredientschildNodes; i++) {
            cocktail_ingredients_value.push(upload_ingredients_container.children[i].value);
        }
        ...
        let taste_category_result = document.getElementById("upload_taste_category");
        ...
        let upload_steps_container = document.getElementById("upload_steps_container");
        let length_of_uploadstepschildNodes = upload_steps_container.childNodes.length;
    ...
    useEffect(() => {
        if (SuccessfullySubmit === true) {
            axios.post(`http://localhost:5050/cocktails_list`, NewCocktailRecipe)
            .then(res => {
                console.log(res);
    ...
    const AddIngredientsInput = (event) => {
        ...
        new_ingredient_input.classList.add("Upload__RecipeDetailsForm--IngredientsInput");
    ...
    const RemoveIngredientsInput = (event) => {
        ...
        if (length_of_childNodes > 1) {
            upload_ingredients_container.removeChild(upload_ingredients_container.children[length_of_childNodes-1]);
        }
    }
    ...
    const RemoveStepsInput = (event) => {
        ...
        if (length_of_childNodes > 1) {
            upload_steps_container.removeChild(upload_steps_container.children[length_of_childNodes-1]);
        }
    }
            ...
            <section className="Upload">
                ...
                <form className="Upload__form" id="Upload__form" onSubmit={onSubmit}>
                    <div className="Upload__form--AuthorInfo">
                        ...
                        <input id="Recipe_Author_Name" className="Upload__AuthorInfoForm--textinput" type="text" placeholder="John" required/>
                        

                        <label className="Upload__AuthorInfoForm--title">Author Email</label>
                        <input id="Recipe_Author_Email" className="Upload__AuthorInfoForm--textinput" type="email" placeholder="John@gmail.com" required/>
                    </div>
                    ...
                    <div className="Upload__form--RecipeDetails">
                        ...
                        <div className="Upload-form__RecipeDetails--sectioncontainer">
                            <div className="Upload-form__RecipeDetails--sectionone">
                                <label className="Upload__RecipeDetailsForm--title">Cocktail Name</label>
                                <input id="Recipe_Name" className="Upload__RecipeDetailsForm--textinput" type="text" placeholder="Margarita (max word count: 15)" maxLength="15" required/>

                                <label className="Upload__RecipeDetailsForm--title">Cocktail Ingredients</label>
                                <div className="Upload__RecipeDetailsForm--IngredientsContainer" id="upload_ingredients_container">
                                    <input type="text" className="Upload__RecipeDetailsForm--IngredientsInput" placeholder="1 half lime" required/>
                                </div>
                                
                                <div className="Upload__RecipeDetailsForm--IngredientsButtonContainer">
                                    <button className="Upload__RecipeDetailsForm--AddIngredientsInput" onClick={AddIngredientsInput}>Add</button>
                                    <button className="Upload__RecipeDetailsForm--RemoveIngredientsInput" onClick={RemoveIngredientsInput}>Remove</button>
                                </div>

                                <label className="Upload__RecipeDetailsForm--title">Liquor Type</label>
                                <div className="Upload__RecipeDetailsForm--LiquorTypeContainer">
                                    <div className="Upload__RecipeDetailsForm--LiquorType">
                                        <input type="checkbox" name="Liquor_Type" value="Absinthe"/>
                                        <div className="Upload__RecipeDetailsForm--LiquorTypeTitle">Absinthe</div>
                                    </div>
                                    <div className="Upload__RecipeDetailsForm--LiquorType">
                                        <input type="checkbox" name="Liquor_Type" value="Brandy" />
                                        <div className="Upload__RecipeDetailsForm--LiquorTypeTitle">Brandy</div>
                                    </div>
                                    <div className="Upload__RecipeDetailsForm--LiquorType">
                                        <input type="checkbox" name="Liquor_Type" value="Cognac" />
                                        <div className="Upload__RecipeDetailsForm--LiquorTypeTitle">Cognac</div>
                                    </div>
                                    <div className="Upload__RecipeDetailsForm--LiquorType">
                                        <input type="checkbox" name="Liquor_Type" value="Gin" />
                                        <div className="Upload__RecipeDetailsForm--LiquorTypeTitle">Gin</div>
                                    </div>
                                    <div className="Upload__RecipeDetailsForm--LiquorType">
                                        <input type="checkbox" name="Liquor_Type" value="Jager" />
                                        <div className="Upload__RecipeDetailsForm--LiquorTypeTitle">Jager</div>
                                    </div>
                                    <div className="Upload__RecipeDetailsForm--LiquorType">
                                        <input type="checkbox" name="Liquor_Type" value="Rum" />
                                        <div className="Upload__RecipeDetailsForm--LiquorTypeTitle">Rum</div>
                                    </div>
                                    <div className="Upload__RecipeDetailsForm--LiquorType">
                                        <input type="checkbox" name="Liquor_Type" value="Schnapps" />
                                        <div className="Upload__RecipeDetailsForm--LiquorTypeTitle">Schnapps</div>
                                    </div>
                                    <div className="Upload__RecipeDetailsForm--LiquorType">
                                        <input type="checkbox" name="Liquor_Type" value="Sambuca" />
                                        <div className="Upload__RecipeDetailsForm--LiquorTypeTitle">Sambuca</div>
                                    </div>
                                    <div className="Upload__RecipeDetailsForm--LiquorType">
                                        <input type="checkbox" name="Liquor_Type" value="Tequila" />
                                        <div className="Upload__RecipeDetailsForm--LiquorTypeTitle">Tequila</div>
                                    </div>
                                    <div className="Upload__RecipeDetailsForm--LiquorType">
                                        <input type="checkbox" name="Liquor_Type" value="Vermouth" />
                                        <div className="Upload__RecipeDetailsForm--LiquorTypeTitle">Vermouth</div>
                                    </div>
                                    <div className="Upload__RecipeDetailsForm--LiquorType">
                                        <input type="checkbox" name="Liquor_Type" value="Vodka" />
                                        <div className="Upload__RecipeDetailsForm--LiquorTypeTitle">Vodka</div>
                                    </div>
                                    <div className="Upload__RecipeDetailsForm--LiquorType">
                                        <input type="checkbox" name="Liquor_Type" value="Whiskey" />
                                        <div className="Upload__RecipeDetailsForm--LiquorTypeTitle">Whiskey</div>
                                    </div>
                                </div>
                            </div>

                            <div className="Upload-form__RecipeDetails--sectiontwo">
                                <label className="Upload__RecipeDetailsForm--title">Mood Category</label>
                                <select className="Upload__RecipeDetailsForm--MoodCategoryDropdown" id="upload_mood_category" name="upload_mood_category">
                                ...
                                <label className="Upload__RecipeDetailsForm--title">Taste Category</label>
                                <select className="Upload__RecipeDetailsForm--TasteCategoryDropdown" id="upload_taste_category" name="upload_taste_category">
                                ...
                                <label className="Upload__RecipeDetailsForm--title">Steps to Make</label>
                                <div className="Upload__RecipeDetailsForm--StepsContainer" id="upload_steps_container">
                                    <input type="text" className="Upload__RecipeDetailsForm--StepsInput" placeholder="Sprinkle salt on a small plate." required/>
                                    {/* <input type="hidden" value="1" id="total_steps"/> */}
                                </div>
                                <div className="Upload__RecipeDetailsForm--StepsButtonContainer">
                                    <button className="Upload__RecipeDetailsForm--AddStepsInput" onClick={AddStepsInput}>Add Step</button>
                                    <button className="Upload__RecipeDetailsForm--RemoveStepsInput" onClick={RemoveStepsInput}>Remove Step</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="Upload__form--SubmitButtonContainer">
                        <input className="Upload__form--ResetButton" type="reset" value="Reset" />
                        <input className="Upload__form--SubmitButton" type="submit" value="Submit"/>
                    </div>
                </form>
            </section>
        </>
